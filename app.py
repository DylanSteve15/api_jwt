...
Configura la conexión a la base de datos (MySQL o SQLite), JWT y registra los blueprints de los controladores.
"""
...
if not db_url:
    ...
    logger.warning("MYSQL_URL no definido. Usando SQLite local 'sqlite:///flaskapi.db'.")
    db_url = "sqlite:///flaskapi.db"

app.config["SQLALCHEMY_DATABASE_URI"] = db_url
app.config["SQLALCHEMY_TRACK_MODIFICATIONS"] = False
app.config["JWT_SECRET_KEY"] = os.getenv("JWT_SECRET_KEY", "clave_secreta_jwt")
    ...
    return (
        {
            ...
            "repository": "https://github.com/DylanSteve1530/API_JWT",
        },
        200,
    )
